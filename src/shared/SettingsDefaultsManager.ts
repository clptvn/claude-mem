...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_CODEX_PATH: '',  // Empty = auto-detect Codex CLI from PATH and known install locations
    CLAUDE_MEM_CODEX_REASONING_EFFORT: 'low',  // Memory extraction is structured and repeatable
